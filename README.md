# Hi! <img src="https://media.giphy.com/media/l3AzYLeRN2QCfnxY1c/giphy.gif?cid=790b7611q2968v6vcdk2rjr60ee12u1w8n0epl5v8q77n9ej&ep=v1_stickers_search&rid=giphy.gif&ct=s" width="50px"> 

很高興認識你！  
我是 **Deemo**，這裡分享我過去使用 TensorFlow 開發的一些股票預測作品，以及我用 MQL5 開發的外匯策略和分析。歡迎有興趣的朋友交流討論！
...
具備扎實的 Python 開發經驗，專注於金融數據分析和機器學習。熟悉使用 PostgreSQL 數據庫進行數據提取和處理，並能夠運用 Keras 構建和訓練神經網絡模型。擅長於開發和實現交易策略，能夠從歷史數據中提取有價值的見解並進行預測。同時也有開發過聊天機器人的經驗，擅長使用 Flask 框架構建 Web 應用，並能夠整合各種 API 以實現高效的數據處理和用戶互動，具備良好的問題解決能力和團隊合作精神，致力於開發創新的技術和解決方案。
...
- **工具與框架**：Git, Jupyter Notebook, Flask, LINE Bot SDK
